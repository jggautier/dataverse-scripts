...
* [Visit the releases page](https://github.com/jggautier/dataverse-scripts/releases) to download the ZIP file with the latest version. If you're using Google Chrome when you download the ZIP file, keep an eye out for the browser giving a warning about downloading the ZIP file. You might have to tell Google Chrome that the download is safe
