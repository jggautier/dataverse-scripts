# Script for creating links to datasets in a given text file into a given dataverse
...
print('Choose a text file with database IDs of the datasets/dataverses to link or unlink:')
...
dataverse_url = raw_input('\n' + 'Enter full URL of dataverse to add links to, e.g. http(s)://demo.dataverse.org/dataverse/mydataverse:') # e.g. demo
